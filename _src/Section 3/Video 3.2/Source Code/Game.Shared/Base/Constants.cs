...
namespace Game.Shared.Base
{
    ...
    public static class Constants
    {
        ...
        /// <summary> The request code for viewing leaderboards on Google Play Services </summary>
        public const Int32 LEADERBOARD_REQUEST_CODE = 4002;

        /// <summary> The ID for app in Google Analytics  </summary>
        public const String ANALYTICS_ID = "YOUR_ID";
    }
}
