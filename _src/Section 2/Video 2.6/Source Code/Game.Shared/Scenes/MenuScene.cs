...
namespace Game.Shared.Scenes
{
    ...
    public class MenuScene : FadeScene
    {
        ...
        /// <summary> The button used to view achievements </summary>
        public Button AchievementButton { get; }
        /// <summary> The button used to view leaderboards </summary>
        ...
        public MenuScene()
        {
            ...
            AchievementButton = new Button(ZOrders.SCORE_TEXT, new Sprite(ZippyGame.UICanvas, ZOrders.SCORE_TEXT, Texture.GetTexture("Content/Graphics/Buttons/AchievementButton.png")) { Colour = new OpenTK.Vector4(1, 1, 1, 0) })
            {
                Position = new OpenTK.Vector2(-900, -470),
                Visible = true,
                TouchEnabled = false
            };

            LeaderboardButton = new Button(ZOrders.SCORE_TEXT, new Sprite(ZippyGame.UICanvas, ZOrders.SCORE_TEXT, Texture.GetTexture("Content/Graphics/Buttons/LeaderboardButton.png")) { Colour = new OpenTK.Vector4(1, 1, 1, 0) })
            {
                Position = new OpenTK.Vector2(644, -470),
                Visible = true,
                TouchEnabled = false
            };
        ...
        public override void ToggleButtonStates(Boolean toEnable)
        {
            ...
            AchievementButton.TouchEnabled = toEnable;
            LeaderboardButton.TouchEnabled = toEnable;
        }
        ...
        protected override void SetElementAlpha(Single alpha)
        {
            ...
            AchievementButton.Sprite.Colour = new OpenTK.Vector4(1, 1, 1, alpha);
            LeaderboardButton.Sprite.Colour = new OpenTK.Vector4(1, 1, 1, alpha);
